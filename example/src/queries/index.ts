...
export type GoodbyeMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'goodbye'>
);
...
export const goodbye = (options?: Omit<MutationOptions<GoodbyeMutation, GoodbyeMutationVariables>, 'mutation' | 'variables'>) => {
...
export const hello = (variables: HelloQueryVariables, options?: Omit<QueryOptions<HelloQueryVariables>, 'query' | 'variables'>) => {
